...
class ScheduleTest extends Specification {
    ...
    def 'test recurrence creation'() {
        ...
        Schedule.DAILY                             | 'RRULE:FREQ=DAILY;INTERVAL=1\r\n'
        new Schedule(Weeks.of(3))                  | 'RRULE:FREQ=WEEKLY;INTERVAL=3\r\n'
        new Schedule(Weeks.of(2))
                .until(LocalDate.of(2022, 12, 23))
                .on(MONDAY, WEDNESDAY)             | 'RRULE:FREQ=WEEKLY;UNTIL=20221223;INTERVAL=2;BYDAY=MO,WE\r\n'
        new Schedule(Months.of(3)).on(1, 15)       | 'RRULE:FREQ=MONTHLY;INTERVAL=3;BYMONTHDAY=1,15\r\n'
        Schedule.YEARLY.on(APRIL, MAY).times(3)    | 'RRULE:FREQ=YEARLY;COUNT=3;INTERVAL=1;BYMONTH=4,5\r\n'
    }
}
